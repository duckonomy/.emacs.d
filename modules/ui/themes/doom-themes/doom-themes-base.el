...
(defvar doom-themes-base-faces
  '(;; --- custom faces -----------------------
	...
	;; mic-paren
	(paren-face-match    :foreground red   :background base0 :weight 'normal)
	(paren-face-mismatch :foreground base0 :background red   :weight 'normal)
	(paren-face-no-match :inherit 'paren-face-mismatch :weight 'normal)
