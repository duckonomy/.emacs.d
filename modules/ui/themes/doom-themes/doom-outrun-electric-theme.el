...
(def-doom-theme doom-outrun-electric
  ...
  ((company-tooltip-selection     :background dark-cyan)
   ...
   ((outline-1 &override) :height 1.0 :weight 'bold :foreground blue)
   ((outline-2 &override) :height 1.0 :weight 'bold :foreground green)
   ((outline-3 &override) :height 1.0 :weight 'bold :foreground teal)
   ((outline-4 &override) :height 1.0 :weight 'bold :foreground (doom-darken blue 0.2))
   ((outline-5 &override) :height 1.0 :weight 'bold :foreground (doom-darken green 0.2))
   ((outline-6 &override) :height 1.0 :weight 'bold :foreground (doom-darken teal 0.2))
   ((outline-7 &override) :height 1.0 :weight 'bold :foreground (doom-darken blue 0.4))
   ((outline-8 &override) :height 1.0 :weight 'bold :foreground (doom-darken green 0.4))

   ;; org-mode
   ((org-block &override) :weight 'bold :background base0 :height 0.9 :inherit 'fixed-pitch :extend t)
   (org-block-background :extend t)

   (org-code :weight 'bold :height 0.9 :inherit 'fixed-pitch :foreground (doom-darken green 0.2))
   (org-table :weight 'bold :height 1.4 :inherit 'fixed-pitch)
   (org-document-title :weight 'bold :height 1.7)
