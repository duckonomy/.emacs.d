...
(def-doom-theme doom-solarized-light
  ...
  ((elscreen-tab-other-screen-face :background "#353a42" :foreground "#1e2022")
   ...
   ((outline-1 &override) :foreground fg :height 1.4 :weight 'bold)
   ((outline-2 &override) :foreground fg :height 1.4 :weight 'bold)
   ((outline-3 &override) :foreground fg :height 1.4 :weight 'bold)
   ((outline-4 &override) :foreground fg :height 1.4 :weight 'bold)
   ((outline-5 &override) :foreground fg :height 1.4 :weight 'bold)
   ((outline-6 &override) :foreground fg :height 1.4 :weight 'bold)
   ((outline-7 &override) :foreground fg :height 1.4 :weight 'bold)
   ((outline-8 &override) :foreground fg :height 1.4 :weight 'bold)

   (org-block :weight 'bold :background (doom-blend yellow bg 0.04) :height 0.9 :inherit 'fixed-pitch :extend t)
   ...
   (org-code :foreground orange :weight 'bold :height 0.9 :inherit 'fixed-pitch)
   (org-table :weight 'bold :height 1.4 :inherit 'fixed-pitch)
   (org-document-title :foreground magenta :weight 'bold :height 1.7)
   (org-special-keyword :height 1.4)
   (org-hide :background bg :foreground bg)
   (org-todo :weight 'bold :box '(:line-width 1 :color "#D8ABA7") :foreground "#D8ABA7" :background "#FFE6E4")
   (org-done :weight 'bold :box '(:line-width 1 :color "#BBBBBB") :foreground "#A3BAA4" :background "#DBF2D3")
